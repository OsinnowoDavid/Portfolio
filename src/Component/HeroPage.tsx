...
export function Hero() {
  return (
    <section className="w-full mt-20 px-4 py-20 flex flex-col items-center justify-center gap-[40px] text-center">
      ...
      {/* CTA Button */}
      <a href="mailto:davidadewale151@gmail.com" className="flex items-center justify-center gap-[10px] py-[16px] px-[24px] bg-[#0F1115] rounded-[100px] transition-transform hover:scale-105 active:scale-95 group">
